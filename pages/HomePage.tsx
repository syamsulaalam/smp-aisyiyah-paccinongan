...
const HomePage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${import.meta.env.VITE_API_URL}/visit`, { method: 'POST' })
            .catch(err => console.error("Gagal mencatat pengunjung", err));
    }, []);
    ...
    return (
        <Layout>
            ...
            <section
                ...
                style={{ backgroundImage: "url('https://lh3.googleusercontent.com/gps-cs-s/AHVAweqiHZNoHScmUhY4L5JQTP8cBdfDPL3-6OMw2HlyJaa4xpeQlHsacSfL0gAgFbqwkGIerObRchm6wm9V_qqZMPMzFu6_Y8PPmvVh7hbNhf6PCS0hHkJjWoTUZqV8yC8ydnfCG6YQxg=s1360-w1360-h1020-rw')" }}
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-xl">
                        ...
                        <p className="mt-4 text-lg md:text-xl text-gray-600">
                            Sekolah Berkemajuan, Unggul dalam Prestasi dan Akhlak Mulia.
                        </p>
                        <NavLink 
                            to="/profil" 
                            className="mt-8 inline-block bg-blue-900 text-white font-bold py-3 px-8 rounded-md hover:bg-blue-600 transition-colors shadow-lg"
                        >
                            Profil Sekolah
                        </NavLink>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="space-y-8">
                            {latestNews.length === 0 ? <p className="text-gray-500">Belum ada berita.</p> : latestNews.map(news => (
                    ...
                    <div className="md:col-span-1">
                        <div className="bg-blue-50 rounded-lg shadow-md p-6 sticky top-24 border border-blue-100">
                            ...
                            <ul className="space-y-4">
                                {agenda.length === 0 ? <p className="text-gray-500">Tidak ada agenda.</p> : agenda.map(item => (
                            ...
                            latestGallery.map(photo => (
                                <div key={photo.id} className="group relative overflow-hidden rounded-lg shadow-lg h-64 bg-gray-100">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                                        <div>
                                            <span className={`text-xs px-2 py-1 rounded text-white mb-2 inline-block ${photo.category === 'Kegiatan' ? 'bg-blue-600' : 'bg-blue-900'}`}>
                                                {photo.category}
                                            </span>
