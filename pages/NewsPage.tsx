                    ...
                    <div key={article.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden bg-white hover:shadow-2xl transition-shadow duration-300">
                      ...
                      <div className="flex-1 p-6 flex flex-col justify-between">
                        <div className="flex-1">
                          <p className="text-sm font-medium text-blue-600">Kegiatan Sekolah</p>
                          <NavLink to={`/berita/${article.id}`} className="block mt-2">
                            <h3 className="text-xl font-semibold text-gray-900 hover:text-blue-700 transition-colors line-clamp-2">{article.title}</h3>
                            <p className="mt-3 text-base text-gray-500 line-clamp-3">{article.content}</p>
                          </NavLink>
                        </div>
                        <div className="mt-6 flex items-center border-t pt-4">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-gray-900">Admin Sekolah</p>
